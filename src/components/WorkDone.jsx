    ...
    return (
        <div className='w-96 pb-3 flex flex-col items-center border-2 border-gray-400 rounded-sm'>
            ...
            <div className='w-full py-3 flex justify-evenly items-center'>
                {ytlink && <a className='px-2 py-3 bg-rose-500 text-white rounded-sm hover:bg-rose-600 active:bg-rose-800' href={ytlink} target='__blank'>Full Interview</a>}
                {insta && <a className='px-2 py-3 bg-pink-500 text-white rounded-sm hover:bg-pink-600 active:bg-pink-800' href={insta} target='__blank'>Instagram Post</a>}
            </div>
